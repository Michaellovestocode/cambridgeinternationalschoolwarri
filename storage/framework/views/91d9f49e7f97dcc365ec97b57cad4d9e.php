                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="border border-blue-100 bg-blue-50 rounded-2xl p-4">
                        <div class="flex justify-between items-start gap-3">
                            <div>
                                <p class="text-sm font-semibold text-gray-900"><?php echo e($message->subject ?: 'School message'); ?></p>
                                <p class="text-xs text-blue-700"><?php echo e($message->sender?->name ?? 'School Admin'); ?> â€¢ <?php echo e($message->created_at->format('M j, Y')); ?></p>
                            </div>
                            <?php if($message->isUnread()): ?>
                                <span class="text-xs px-3 py-1 rounded-full bg-white text-blue-700 font-semibold">New</span>
                            <?php endif; ?>
                        </div>
                        <p class="text-sm text-gray-700 mt-2"><?php echo e(\Illuminate\Support\Str::limit($message->body, 180)); ?></p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <p class="text-sm text-gray-500">No school messages yet.</p>
                <?php endif; ?>

                <a href="<?php echo e(route('parent.messages.index')); ?>" class="inline-flex text-sm font-semibold text-blue-600 hover:underline">
                    Open all messages
                </a>
