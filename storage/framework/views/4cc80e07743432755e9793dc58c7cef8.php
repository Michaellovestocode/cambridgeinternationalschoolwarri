    ...
    <style>
        * {
        ...
        .student-info {
            margin-bottom: 8px;
            font-size: 10px;
            border: 1px solid <?php echo e($selectedColor['primary']); ?>;
            background: #fff;
        }
        ...
        .total-cell {
            background: <?php echo e($selectedColor['light']); ?> !important;
            font-weight: bold;
            color: <?php echo e($selectedColor['primary']); ?>;
        }
        ...
        .summary-box {
            border: 1.5px solid <?php echo e($selectedColor['primary']); ?>;
            padding: 4px;
            margin-bottom: 5px;
        ...
        .summary-title {
            ...
            font-size: 9px;
            color: #111827;
            border-bottom: 1px solid <?php echo e($selectedColor['secondary']); ?>;
        }
        ...
        .next-term-box {
            ...
            padding: 5px;
            font-size: 10px;
            border-top: 1px solid <?php echo e($selectedColor['primary']); ?>;
            border-bottom: 1px solid <?php echo e($selectedColor['primary']); ?>;
            background: <?php echo e($selectedColor['light']); ?>;
        }
...
<body>
    ...
    <div class="page">
        ...
        <div class="watermark">
            <img src="<?php echo e($schoolLogoSrc); ?>" alt="School Watermark">
        </div>
            ...
            <table class="header-table">
                <tr>
                    <td class="header-logo-cell">
                        <img src="<?php echo e($schoolLogoSrc); ?>" class="school-logo" alt="School Logo">
                    </td>
                    <td class="header-content-cell">
                        <div class="school-name"><?php echo e(strtoupper($schoolSettings->school_name ?: 'Cambridge International School')); ?></div>
                        <div class="school-address"><?php echo e($schoolAddress); ?></div>
                        <div class="school-contact">
                            <span class="contact-label">Tel:</span> <?php echo e($schoolSettings->school_phone ?: '08032897744'); ?>

                            <span class="contact-label"> | Email:</span>
                            <span class="contact-value"><?php echo e($schoolEmail); ?></span>
                        </div>
                        <div class="school-contact">
                            <span class="contact-label">Website:</span>
                            <span class="contact-value"><?php echo e($schoolWebsite); ?></span>
                        </div>
                        ...
                        <div class="report-meta">
                            <?php echo e(strtoupper($reportCard->session->name)); ?> ACADEMIC SESSION
                        </div>
                    </td>
                    <td class="header-photo-cell">
                        <?php if($studentPhotoSrc): ?>
                            <img src="<?php echo e($studentPhotoSrc); ?>" class="student-photo" alt="Student Photo">
                        <?php else: ?>
        ...
        <div class="student-info">
            ...
            <div class="info-row">
                ...
                <div class="info-cell" style="width: 45%;"><?php echo e(strtoupper($clubSociety)); ?></div>
                <div class="info-cell info-label">FAV. COLOUR:</div>
                <div class="info-cell"><?php echo e(strtoupper($favouriteColour)); ?></div>
            </div>
        </div>
                ...
                <table class="scores-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="total-cell"><?php echo e(number_format($score->total, 1)); ?></td>
                            <td class="
                            ...
                            <td class="position-cell"><?php echo e($score->position); ?>/<?php echo e($score->total_students); ?></td>
                            <td><?php echo e(strtoupper($score->remark)); ?></td>
                        </tr>
            ...
            <div class="official-sidebar">
                ...
                <div class="summary-box">
                    ...
                    <table class="traits-table">
                        ...
                        <?php $__currentLoopData = $affectiveTraits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $trait): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td style="text-align: left;"><?php echo e($trait); ?></td>
                                <?php for($rating = 5; $rating >= 1; $rating--): ?>
                                    <td><?php echo (int) data_get($reportCard->affective_domain, $key) === $rating ? '&#10003;' : ''; ?></td>
                                <?php endfor; ?>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </table>
                ...
                <div class="summary-box">
                    ...
                    <table class="traits-table">
                        ...
                        <?php $__currentLoopData = $psychomotorTraits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td style="text-align: left;"><?php echo e($skill); ?></td>
                                <?php for($rating = 5; $rating >= 1; $rating--): ?>
                                    <td><?php echo (int) data_get($reportCard->psychomotor_skills, $key) === $rating ? '&#10003;' : ''; ?></td>
                                <?php endfor; ?>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </table>
                ...
                <div style="border: 1.5px solid <?php echo e($selectedColor['primary']); ?>; text-align: center; background: rgba(255, 255, 255, .92);">
                    <div style="background: <?php echo e($selectedColor['primary']); ?>; color: #fff; font-weight: bold; font-size: 9px; padding: 3px;">OVERALL GRADE</div>
        ...
        <div class="footer">
            ...
            <div class="official-note">This report is issued by <?php echo e($schoolSettings->school_name ?: 'Cambridge International School'); ?> and is valid with authorised school remarks.</div>
            <div style="margin-top: 3px;">&copy; <?php echo e(date('Y')); ?> <?php echo e($schoolSettings->school_name ?: 'Cambridge International School'); ?></div>
        </div>
    </div>
</body>
</html>
