    ...
    <div class="page">
        ...
        <div class="summary-section">
            ...
            <div class="summary-col">
                ...
                <!-- Grade Box -->
            <div style="border: 2px solid <?php echo e($selectedColor['primary']); ?>; text-align: center; background: rgba(255, 255, 255, .92);">
                <div style="background: <?php echo e($selectedColor['primary']); ?>; color: #fff; font-weight: bold; font-size: 10px; padding: 4px;">OVERALL GRADE</div>
