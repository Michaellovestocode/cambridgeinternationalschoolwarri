        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-yellow-700 mt-1">
                    This student (<strong><?php echo e($attempt->student->name); ?></strong>) hasn't submitted yet. 
                    You can submit it on their behalf if needed.
                </p>
            </div>
            <form method="POST" 
                  action="<?php echo e(route('admin.submit-for-student', $attempt->id)); ?>" 
                  onsubmit="return confirm('⚠️ Submit this exam for <?php echo e($attempt->student->name); ?>?\n\nThis will:\n✓ Mark exam as completed\n✓ Auto-grade MCQ/Fill-blank questions\n✓ Stop the timer\n\nThis action cannot be undone!')">
                <?php echo csrf_field(); ?>
                <button type="submit" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\modern-cbt-platform-for-highschool\resources\views\admin\exams\grade.blade.php ENDPATH**/ ?>