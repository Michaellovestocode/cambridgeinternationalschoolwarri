                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div>
                        ...
                        <input type="number" name="days_school_opened" id="days_school_opened" min="0" required
                               value="<?php echo e($reportCard ? $reportCard->days_school_opened : ''); ?>"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                        <?php $__errorArgs = ['days_school_opened'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="days_present" id="days_present" min="0" required
                               value="<?php echo e($reportCard ? $reportCard->days_present : ''); ?>"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                        <?php $__errorArgs = ['days_present'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="mt-1 text-sm text-red-600"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="days_absent" id="days_absent" min="0" required
                               value="<?php echo e($reportCard ? $reportCard->days_absent : ''); ?>"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                        <?php $__errorArgs = ['days_absent'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="mt-1 text-sm text-red-600"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="attendance_percentage" id="attendance_percentage" min="0" max="100" step="0.01" required
                               value="<?php echo e($reportCard ? $reportCard->attendance_percentage : ''); ?>"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <textarea name="class_teacher_comment" id="class_teacher_comment" rows="3" maxlength="500"
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                          placeholder="Enter class teacher's comment..."><?php echo e($reportCard ? $reportCard->class_teacher_comment : ''); ?></textarea>
                <?php $__errorArgs = ['class_teacher_comment'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="mt-1 text-sm text-red-600"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <textarea name="head_teacher_comment" id="head_teacher_comment" rows="3" maxlength="500"
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                          placeholder="Enter head teacher's comment..."><?php echo e($reportCard ? $reportCard->head_teacher_comment : ''); ?></textarea>
                <?php $__errorArgs = ['head_teacher_comment'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="mt-1 text-sm text-red-600"><?php echo e($message); ?></p><?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\modern-cbt-platform-for-highschool\resources\views\teacher\report-card-form.blade.php ENDPATH**/ ?>