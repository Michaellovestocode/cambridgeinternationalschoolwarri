...
<div class="bg-blue-900 text-white text-sm py-3 shadow-lg fixed top-0 left-0 right-0 z-[60] ticker-wrap border-b-4 border-yellow-400">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center gap-3 sm:gap-4">
            ...
            <div id="topTickerText" class="ticker-viewport flex-1 font-bold uppercase text-white text-xs sm:text-sm lg:text-base" data-messages='<?php echo json_encode($tickerMessages, 15, 512) ?>'>
                <div class="ticker-track">
                    <span class="ticker-item"><?php echo e($tickerLine); ?></span>
                    <span class="ticker-item" aria-hidden="true"><?php echo e($tickerLine); ?></span>
                </div>
            </div>
        </div>
    </div>
    <div class="sr-only"><?php echo e($tickerLine); ?></div>
</div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-[1.05fr_.95fr] gap-10 lg:gap-14 items-center">
            ...
            <div class="fade-in-up" style="transition-delay:.15s">
                <div class="relative">
                    <img src="<?php echo e(asset('images/school life1.jpg')); ?>" alt="Cambridge students learning" class="w-full h-72 sm:h-[420px] object-cover rounded-[2rem] shadow-2xl border border-white/15">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8">
            ...
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden card-hover fade-in-up">
                <div class="relative">
    <img src="<?php echo e(asset('images/director2.png')); ?>" alt="Director" class="w-full h-64 object-cover">
...
<section id="news" class="py-16 sm:py-24 bg-white">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php $__currentLoopData = $homepageAnnouncements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                ?>
                <article class="bg-white rounded-3xl shadow-lg overflow-hidden card-hover fade-in-up border border-gray-100" <?php if($index > 0): ?> style="transition-delay:.<?php echo e($index); ?>s" <?php endif; ?>>
                    <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($announcement->title); ?>" class="w-full h-60 object-cover" onerror="this.onerror=null;this.src='<?php echo e($fallbackImageUrl); ?>';">
                    <div class="p-6">
                        <div class="mb-3 flex flex-wrap items-center gap-2">
                            <span class="inline-block text-xs font-bold <?php echo e($style["badge"]); ?> px-3 py-1 rounded-full"><?php echo e($announcement->category_label); ?></span>
                        ...
                        <h3 class="font-black text-gray-900 text-lg mb-2"><?php echo e($announcement->title); ?></h3>
                        <p class="text-sm text-gray-500 mb-4"><?php echo e($announcement->summary); ?></p>
                        <div class="flex items-center justify-between gap-4 text-xs text-gray-400">
                            <span><?php echo e($announcement->display_date); ?><?php if(!empty($announcement->location)): ?> · <?php echo e($announcement->location); ?><?php endif; ?></span>
                            <a href="<?php echo e($buttonUrl); ?>" class="text-blue-600 font-semibold hover:underline"><?php echo e($buttonLabel); ?></a>
                        </div>
                    </div>
                </article>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<section class="py-16 sm:py-24 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 relative overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center fade-in-up">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?php echo e(route('apply.create')); ?>" class="bg-white text-gray-900 px-10 py-4 rounded-full font-black text-lg hover:shadow-2xl transition transform hover:scale-105">
                Apply for Admission
            </a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-green-50 p-8 rounded-3xl shadow-lg fade-in-up" style="transition-delay:.15s">
                ...
                <a href="<?php echo e(route('apply.create')); ?>" class="mb-5 inline-flex items-center rounded-full bg-gradient-to-r from-amber-400 to-orange-500 px-5 py-2 text-sm font-bold text-gray-900 shadow hover:shadow-lg">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-3 text-gray-400">
                    ...
                    <li class="flex items-start space-x-2"><span class="font-semibold text-white">Website:</span><a href="https://www.cambridgeinternationalschools.com" target="_blank" rel="noopener noreferrer" class="break-anywhere hover:text-yellow-400 transition">www.cambridgeinternationalschools.com</a></li>
...
<script>
    ...
    async function submitForm(event) {
        ...
        try {
            const response = await fetch("<?php echo e(route('admission-enquiries.store')); ?>", {
                method: 'POST',
                headers: {
