...
<div class="max-w-6xl mx-auto px-4 py-8">
    ...
    <div class="bg-blue-50 border border-blue-300 rounded-lg p-4 mb-6">
        <p class="text-blue-800">
            <strong>Viewing Session:</strong> <?php echo e($selectedSession->name ?? 'N/A'); ?> | 
            <strong>Term:</strong> <?php echo e($selectedTerm->name ?? 'N/A'); ?>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 mb-8">
        <form method="GET" action="<?php echo e(route('teacher.scores.dashboard')); ?>" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
            ...
            <div class="flex items-end gap-3">
                ...
                <a href="<?php echo e(route('teacher.scores.dashboard')); ?>" class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-5 py-3 rounded-lg font-semibold">
                    Reset
                </a>
            </div>
        </form>
