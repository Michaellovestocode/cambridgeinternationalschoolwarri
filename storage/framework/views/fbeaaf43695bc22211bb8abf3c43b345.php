...
<?php $__env->startSection('title', 'Compile Results - ' . $class->name); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex justify-between items-start mb-4">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Compile Results - <?php echo e($class->name); ?></h2>
                <p class="text-gray-600">View and manage exam results for <?php echo e($class->name); ?></p>
            </div>
            <div class="flex gap-3">
                <!-- <a href="<?php echo e(route('teacher.form-teacher.compile-form', $class->id)); ?>"
    ...
    <?php else: ?>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <?php $__currentLoopData = $exams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <th class="px-6 py-4 text-center text-xs font-bold text-gray-600 uppercase tracking-wider">
                                    <?php echo e(substr($exam->title, 0, 15)); ?>

                                    <br>
                                    <span class="text-gray-500 font-normal">(Out of <?php echo e($exam->total_marks); ?>)</span>
                                </th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $resultMatrix; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studentId => $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="font-semibold text-gray-800"><?php echo e($result['name']); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-gray-600"><?php echo e($result['rollNumber']); ?></div>
                                </td>
                                ...
                                <?php $__currentLoopData = $result['exams']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $examId => $examResult): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <td class="px-6 py-4 text-center">
                                        <?php if($examResult['has_attempt']): ?>
                                            <div class="inline-flex flex-col items-center">
                                                <span class="px-3 py-1 bg-green-100 text-green-800 text-sm rounded-full font-semibold">
                                                    <?php echo e($examResult['score']); ?>/<?php echo e($examResult['total_marks']); ?>

                                                </span>
                                                <span class="text-xs text-gray-500 mt-1">
                                                    <?php echo e(round(($examResult['score'] / $examResult['total_marks']) * 100, 1)); ?>%
                                                </span>
                                            </div>
                                            <?php
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <?php if($examCount > 0): ?>
                                        <span class="font-bold text-gray-800"><?php echo e(round($totalScore / $examCount, 1)); ?>%</span>
                                    <?php else: ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white rounded-lg shadow p-6 text-center">
                <div class="text-3xl font-bold text-blue-600 mb-2"><?php echo e($students->count()); ?></div>
                <div class="text-gray-600 font-semibold">Total Students</div>
            </div>
            <div class="bg-white rounded-lg shadow p-6 text-center">
                <div class="text-3xl font-bold text-green-600 mb-2"><?php echo e($exams->count()); ?></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\modern-cbt-platform-for-highschool\resources\views\teacher\compile-results.blade.php ENDPATH**/ ?>