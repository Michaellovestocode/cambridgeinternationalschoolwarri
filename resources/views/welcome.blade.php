...
<head>
    ...
    <script type="application/ld+json">
        {
            ...
            "logo": "https://www.cambridgeinternationalschoolwarri.com/icon-512.png",
            "image": "https://www.cambridgeinternationalschoolwarri.com/images/schoollogo.jpg",
            "address": {
                "@@type": "PostalAddress",
            ...
            "itemListElement": [
                {
                    ...
                    "position": 1,
                    "name": "Apply Now",
                    "url": "https://www.cambridgeinternationalschoolwarri.com/apply"
                },
                {
                    "@@type": "SiteNavigationElement",
                    "position": 2,
                    "name": "Education Blog",
                    "url": "https://www.cambridgeinternationalschoolwarri.com/blog"
                },
                {
                    "@@type": "SiteNavigationElement",
                    "position": 3,
                    "name": "News And Events",
                    "url": "https://www.cambridgeinternationalschoolwarri.com/#news"
                },
                {
                    "@@type": "SiteNavigationElement",
                    "position": 4,
                    "name": "Contact Cambridge International School Warri",
                    "url": "https://www.cambridgeinternationalschoolwarri.com/#contact"
                }
            ]
        }
    </script>
    ...
    <style>
        * { font-family: 'Poppins', sans-serif; }
        ...
        .mobile-menu-toggle.is-open .menu-line-middle {
            opacity: 0;
        }
        .mobile-menu-toggle.is-open .menu-line-bottom {
            transform: translateY(-6px) rotate(-45deg);
        }
    ...
    <div class="mobile-menu-panel flex h-full max-h-[calc(100vh-5.75rem)] flex-col overflow-hidden rounded-[1.5rem] border border-white/70 p-4 shadow-2xl sm:rounded-[2rem]">
        ...
        <div class="mobile-menu-content flex min-h-0 flex-1 flex-col justify-between gap-3">
            <div class="mobile-menu-links grid gap-2">
                ...
                <a href="#news" onclick="toggleMenu()" class="mobile-menu-link"><span>04</span><strong>News</strong><em class="not-italic text-rose-500">Latest</em></a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="flex items-center space-x-4">
                ...
                <button id="mobileMenuButton" onclick="toggleMenu()" class="mobile-menu-toggle lg:hidden rounded-full border border-blue-100 bg-white p-2.5 shadow-sm" aria-label="Open menu">
                    <svg class="h-6 w-6 text-slate-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path class="menu-line menu-line-top" stroke-linecap="round" stroke-width="2.4" d="M5 7h14"/>
                        <path class="menu-line menu-line-middle" stroke-linecap="round" stroke-width="2.4" d="M5 12h14"/>
                        <path class="menu-line menu-line-bottom" stroke-linecap="round" stroke-width="2.4" d="M5 17h14"/>
                    </svg>
                </button>
            </div>
        </div>
