...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow p-8">
        ...
        <form action="{{ route('admin.teacher.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <select name="report_authority_role" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-green-500">
                    ...
                    <option value="head_teacher" @selected(old('report_authority_role') === 'head_teacher')>Head Teacher</option>
                    <option value="principal" @selected(old('report_authority_role') === 'principal')>Principal</option>
                </select>
