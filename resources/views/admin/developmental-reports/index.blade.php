                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        @endif
                                        <a href="{{ route('admin.developmental-reports.edit', ['student' => $student, 'session_id' => $selectedSessionId, 'term_id' => $selectedTermId]) }}" class="rounded-xl bg-emerald-600 px-4 py-2 text-sm font-black text-white hover:bg-emerald-700">Fill Report</a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
