    ...
    <div class="statistics">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-box">
                ...
                <div class="stat-value">{{ $statistics['graded'] }}</div>
            </div>
            <div class="stat-box">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $attempt->user->class->display_name ?? 'N/A' }}</td>
                <td>{{ $attempt->total_score ?? '—' }}/{{ $attempt->exam->total_marks }}</td>
                <td>
                ...
                <td>
                    @if($attempt->status === 'graded')
                        <span class="status-badge {{ $attempt->total_score >= $attempt->exam->pass_mark ? 'status-pass' : 'status-fail' }}">
