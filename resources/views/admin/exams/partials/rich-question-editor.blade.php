@props(['value' => '', 'name' => 'question_text', 'placeholder' => 'Enter your question here'])

<div x-data="richQuestionEditor(@js($value))" x-init="init()" class="space-y-2">
    <input type="hidden" name="{{ $name }}" x-ref="input" required>
