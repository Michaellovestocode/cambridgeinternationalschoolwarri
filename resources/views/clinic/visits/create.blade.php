...
<div class="mx-auto max-w-4xl space-y-5">
    ...
    <form method="POST" action="{{ route('clinic.visits.store') }}" class="space-y-6 rounded-2xl bg-white p-5 shadow-xl sm:p-8">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:justify-end"><a href="{{ route('clinic.dashboard') }}" class="rounded-xl bg-gray-100 px-5 py-3 text-center text-sm font-bold text-gray-700">← Back to Dashboard</a><button class="rounded-xl bg-blue-700 px-5 py-3 text-sm font-black text-white">Save Clinic Visit</button></div>
    </form>
</div>
<script>
