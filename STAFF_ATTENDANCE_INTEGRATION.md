...
The connector should run on the laptop that can reach `192.168.0.203:5500`, keep a local last-sent event ID, and retry failed website uploads. Do not expose the F-G495 local IP to the public internet.
